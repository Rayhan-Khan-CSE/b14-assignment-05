    ...
    return (
        <footer>
            <div className="border-[#F1F5F9] border my-5">
                <div className="flex flex-col lg:flex-row justify-between max-w-300 mx-auto px-5 lg:pr-20 pb-10 py-6">
                    <div className="text-center lg:text-left">
                        <img src={logo} className="mx-auto lg:mx-0"></img>
                        <p className="text-[#64748B]">Curated tools, technologies, and resources for developers building
                            <br />modern software.</p>
                        <ul className="flex justify-center lg:justify-normal items-center gap-3 pt-4">
                            <li className="font-bold text-[#475569]"><a href="">GitHub</a></li>
                            <li className="lg:hidden"><LuDot /></li>
            ...
            <div className="flex justify-center gap-25 lg:justify-between max-w-300 mx-auto pt-2 pr-4 pb-10">
